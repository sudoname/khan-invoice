        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="https://marketing.kinvoice.ng" class="text-gray-700 hover:text-purple-600 px-3 py-2 rounded-md text-sm font-medium inline-flex items-center gap-1" target="_blank">
