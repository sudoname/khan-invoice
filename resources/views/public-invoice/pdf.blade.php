            ...
            <div style="display: table; width: 100%;">
                ...
                <div style="display: table-cell; width: 30%; text-align: right; vertical-align: top;">
                    <div style="background: white; padding: 10px; display: inline-block;">
                        <img src="data:image/png;base64,{{ base64_encode(QrCode::format('png')->size(120)->generate(route('public-invoice.show', $invoice->public_id))) }}" alt="QR Code" style="width: 120px; height: 120px;">
                    </div>
